                ...
                <section class="wrapper">
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        if (($nama == "") or ($merek == "")) {
                            ...
                            $sql = "UPDATE saw_laptop SET nama='$nama',merek='$merek', kategori='$kategori' 
                    ...
                    <form method="POST" action="">
                        ...
                        ?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">merek Aplikasi</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="merek" value="<?= $merek ?>">
                                </div>
                            </div>
                            <div class="form-group row">
